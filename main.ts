let Princess_character = sprites.create(img`
    . . . . . . 5 . 5 . . . . . . . 
    . . . . . f 5 5 5 f f . . . . . 
    . . . . f 1 5 2 5 1 6 f . . . . 
    . . . f 1 6 6 6 6 6 1 6 f . . . 
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
Princess_character.say("GitHub is Awesome!!")
controller.moveSprite(Princess_character, 100, 100)
Princess_character.setFlag(SpriteFlag.StayInScreen, true)
